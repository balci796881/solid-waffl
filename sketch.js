...
if(level === 9)
{
    ...
    stroke("brown");
    fill("black");
    text("What was the name of second Peverell bother , who owned the Resurrection Stone ? ", 250, 200);
    player.addImage(wand);
    player.x = mouseX;
    player.y = mouseY;
    ...
    textSize(20);
    fill("black");
    text("Antioch Peverell",320,320);
    text("Ignotus Peverell",640,320);
    text("Cadmus Peverell",950,320);
